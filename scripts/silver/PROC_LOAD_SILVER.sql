...
-- =======================================
-- 🚀 Build Silver Layer Clean and Load
-- =======================================
...
SELECT
    ...
    CASE 
        ...
        ELSE 'n/a'
    END,                                     -- Normalize marital status values
    CASE 
        WHEN UPPER(TRIM(cst_gndr)) = 'F' THEN 'Female'
        WHEN UPPER(TRIM(cst_gndr)) = 'M' THEN 'Male'
        ELSE 'n/a'
    END,                                     -- Normalize gender values
    cst_create_date
FROM (
    SELECT *,
...
SELECT
    ...
    CAST(
        ...
        AS DATE
    ) AS prd_end_dt                                                         -- End date as one day before next start
...
SELECT 
    ...
    CASE 
        WHEN sls_price IS NULL OR sls_price <= 0 
            ...
            ELSE sls_price
    END AS sls_price                                                        -- Derive price if missing/invalid
